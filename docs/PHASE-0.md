...
**What comes next is a build, not a measurement.** The plan's own next slice is a physics library that meets the cross-platform determinism requirement and holds the golden hash. The studio's measure is a scene someone has played. The seat thaws when there is a scene.
