...
Mapped at 2026-09-25 from commit ab579ad.
...
- CI now also runs harness/switch.test.js.
- fixtures/ is now also read by harness/switch.test.js.
- fixtures/behavior-3d.json is now also read by harness/switch.test.js.
- fixtures/behavior-minds.json is now also read by harness/switch.test.js.
...
- 1 file added and 20 changed content, across 6 parts.

## What comes in

1. **CI.** On a pull request touching 11 paths; on a push to main touching 11 paths; or by hand. Runs harness/bundle.mjs, harness/bundle.test.js, harness/caps.test.js and 27 more; checks fixtures/golden-arith.txt, fixtures/golden.txt, harness/arith.mjs and 20 more.
