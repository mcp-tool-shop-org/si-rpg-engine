// One trace line per quantum. The format is fixed; packages/tick/difference.js
// parses it, harness/first-difference.js and the replay command print what it
// finds, and docs/PHASE-2.md states it. It lives with the tick because the
// replay command prints it for a bundle (T5); harness/trace-line.mjs
// re-exports it for the harness and the shells.
//
...
import { createHasher, hex } from '../frame/hash.js';
...
/**
 * @typedef {ReturnType<import('./world.js').createWorld>} World
 * @typedef {ReturnType<import('./memory.js').createMemory>} Memory
 */
